...
export default function WatchBtn() {
  return (
    <button className='sm:w-[182px] w-[142px] py-[18px] border-[1px] border-accent4 bg-primary hover:bg-accent2 transition duration-300 ease-in-out cursor-pointer flex gap-[19px] justify-center rounded-[10px]'>
