  ...
  return (
    <div className={`sm:h-[199px] h-[229px] z-[5px] flex items-center ${isLastActive ? 'last' : ''}`}>
      <div style={{
        ...
        }} className='moviecard relative sm:w-[290px] md:w-[330px] desktop-lg:w-[310px] lg:w-[340px] xl:w-[290px] phone-lg:w-[180px] w-[150px] sm:h-[199px] h-[229px] sm:hover:h-[392px] sm:hover:w-[517px] duration-300 ease-in-out hover:z-10 rounded-[15px] flex justify-end overflow-hidden'>
