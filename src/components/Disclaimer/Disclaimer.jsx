const Disclaimer = () => {
  ...
  return (
    <div className="bg-[#490049] text-white p-2 mb-6 px-5">
      ...
      <p className="text-sm md:text-md">
        ...
        videos on our platform infringes upon your rights, please <a href="/contact" className="text-[#C423C4]"> Contact Us</a> for resolution.<a href="/privacy" className="text-[#C423C4]"> Read More
        </a>
      </p>
    </div>
  );
