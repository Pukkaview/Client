...
export default function Carousel({ children }) {
  ...
  const settings = {
    ...
    return (
      <Slider {...settings} afterChange={handleAfterChange} beforeChange={handleBeforeChange} className="z-[1] relative hover:z-[10] pt-[30px] pb-[30px] flex flex-col gap-[50px] mx-auto justify-center">
