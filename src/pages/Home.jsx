        ...
        <div>
          {!active && (
            <>
              ...
              {videos.length === 0 && (
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 my-[50px] md:px-[59px] px-[20px] text-text-color mx-auto">
                  <div>
                    <Skeleton
                      animation="wave"
                      variant="rectangular"
                  ...
                  videos.map((v, i) => (
                    <div className="my-[3vw]">
                      <div className="w-full flex justify-between">
                        <h2 className="sm:text-[20px] text-[16px]">
                          {v.genre}
                        </h2>
                        <div
                          onClick={() =>
                            dispatch({ type: "ACTIVE", payload: v.genre })
                          }>
                          <ViewBtn />
                        </div>
                      </div>
